import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o,c as i,b as n,d as a,e,a as t}from"./app-8ec69b17.js";const c={},u=n("h1",{id:"_2-项目部署",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_2-项目部署","aria-hidden":"true"},"#"),a(" 2 项目部署")],-1),r=n("p",null,"项目前后端分离，可以使用Docker Compose进行部署，或者clone项目到本地后分别打包后部署",-1),d={href:"https://barragefly.ordinaryroad.tech:7000",target:"_blank",rel:"noopener noreferrer"},k={href:"https://pd.qq.com/s/3id0n7fvs",target:"_blank",rel:"noopener noreferrer"},v=n("p",null,"WebSocket地址：wss://barragefly.ordinaryroad.tech:7100",-1),m=n("h2",{id:"_2-1-docker-compose",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_2-1-docker-compose","aria-hidden":"true"},"#"),a(" 2.1 Docker Compose")],-1),y=n("blockquote",null,[n("p",null,[a("Docker Compose示例位于"),n("code",null,".docker"),a("目录中")])],-1),b=n("li",null,[a("arm64系统时，后端镜像请使用 "),n("code",null,"ordinaryroad-barrage-fly-arm64")],-1),g=n("li",null,[a("使用mysql、nginx时需要先build "),n("ul",null,[n("li",null,[n("code",null,"docker compose build ordinaryroad-barrage-fly-mysql")]),n("li",null,[n("code",null,"docker compose build ordinaryroad-barrage-fly-nginx")])])],-1),_={href:"https://www.bejson.com/enc/rsa/",target:"_blank",rel:"noopener noreferrer"},S=n("code",null,"-----BEGIN XXXXX KEY-----",-1),A=n("code",null,"-----END XXXXX KEY-----",-1),f={href:"https://ordinaryroad.coding.net/public-artifacts/ordinaryroad-barrage-fly/docker-pub/packages",target:"_blank",rel:"noopener noreferrer"},h=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># DOCKER_OPTS=&quot;--registry-mirror=https://mirror.ccs.tencentyun.com&quot;</span>
<span class="token comment"># 拉取最新版1.1.3</span>
<span class="token function">docker</span> pull ordinaryroad-docker.pkg.coding.net/ordinaryroad-barrage-fly/docker-pub/ordinaryroad-barrage-fly:1.1.3
<span class="token function">docker</span> pull ordinaryroad-docker.pkg.coding.net/ordinaryroad-barrage-fly/docker-pub/ordinaryroad-barrage-fly-arm64:1.1.3
<span class="token function">docker</span> pull ordinaryroad-docker.pkg.coding.net/ordinaryroad-barrage-fly/docker-pub/ordinaryroad-barrage-fly-ui:1.1.3
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1),R=t(`<blockquote><p>拉到本地后需要根据compose文件重命名镜像</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> tag ordinaryroad-docker.pkg.coding.net/ordinaryroad-barrage-fly/docker-pub/ordinaryroad-barrage-fly:1.1.3 ordinaryroad-barrage-fly
<span class="token function">docker</span> tag ordinaryroad-docker.pkg.coding.net/ordinaryroad-barrage-fly/docker-pub/ordinaryroad-barrage-fly-arm64:1.1.3 ordinaryroad-barrage-fly-arm64
<span class="token function">docker</span> tag ordinaryroad-docker.pkg.coding.net/ordinaryroad-barrage-fly/docker-pub/ordinaryroad-barrage-fly-ui:1.1.3 ordinaryroad-barrage-fly-ui
...
<span class="token comment"># TODO 根据实际部署情况修改</span>
<span class="token comment"># 例如：增加一条host记录\`127.0.0.1 ordinaryroad-barrage-fly\`</span>
<span class="token comment"># SUB_BASE_URL=ws://ordinaryroad-barrage-fly:9898</span>
...
<span class="token key atrule">services</span><span class="token punctuation">:</span>
  ...
  <span class="token key atrule">ordinaryroad-barrage-fly</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">hostname</span><span class="token punctuation">:</span> ordinaryroad<span class="token punctuation">-</span>barrage<span class="token punctuation">-</span>fly
    <span class="token key atrule">restart</span><span class="token punctuation">:</span> always
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-2-本地打包运行" tabindex="-1"><a class="header-anchor" href="#_2-2-本地打包运行" aria-hidden="true">#</a> 2.2 本地打包运行</h2><ol><li>clone项目到本地</li><li>后端打包 <code>./gradlew clean bootJar</code></li><li>前端打包 <code>npm run build</code></li></ol>`,12);function E(M,q){const s=l("ExternalLinkIcon");return o(),i("div",null,[u,r,n("p",null,[a("演示DEMO："),n("a",d,[a("https://barragefly.ordinaryroad.tech:7000"),e(s)]),a("，帐号请前往"),n("a",k,[a("QQ频道"),e(s)]),a("获取")]),v,m,y,n("ul",null,[b,g,n("li",null,[a("在线生成RSA密钥对："),n("a",_,[a("https://www.bejson.com/enc/rsa/"),e(s)]),a(" （不需要第一行的"),S,a("和最后一行的"),A,a("）")])]),n("blockquote",null,[n("p",null,[a("镜像加速与拉取："),n("a",f,[a("仓库链接"),e(s)])]),h]),R])}const Y=p(c,[["render",E],["__file","index.html.vue"]]);export{Y as default};
