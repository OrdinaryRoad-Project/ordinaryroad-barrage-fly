import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o,c as i,b as n,d as a,e,a as t}from"./app-6e7b99c7.js";const c={},u=n("h1",{id:"_2-项目部署",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_2-项目部署","aria-hidden":"true"},"#"),a(" 2 项目部署")],-1),r=n("p",null,"项目前后端分离，可以使用Docker Compose进行部署，或者clone项目到本地后分别打包后部署",-1),d=n("h2",{id:"_2-1-docker-compose",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_2-1-docker-compose","aria-hidden":"true"},"#"),a(" 2.1 Docker Compose")],-1),k=n("blockquote",null,[n("p",null,[a("Docker Compose示例位于"),n("code",null,".docker"),a("目录中")])],-1),v=n("li",null,[a("arm64系统时，后端镜像请使用 "),n("code",null,"ordinaryroad-barrage-fly-arm64")],-1),m=n("li",null,[a("使用mysql、nginx时需要先build "),n("ul",null,[n("li",null,[n("code",null,"docker compose build ordinaryroad-barrage-fly-mysql")]),n("li",null,[n("code",null,"docker compose build ordinaryroad-barrage-fly-nginx")])])],-1),y={href:"https://www.bejson.com/enc/rsa/",target:"_blank",rel:"noopener noreferrer"},b=n("code",null,"-----BEGIN XXXXX KEY-----",-1),g=n("code",null,"-----END XXXXX KEY-----",-1),_={href:"https://ordinaryroad.coding.net/public-artifacts/ordinaryroad-barrage-fly/docker-pub/packages",target:"_blank",rel:"noopener noreferrer"},S=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># DOCKER_OPTS=&quot;--registry-mirror=https://mirror.ccs.tencentyun.com&quot;</span>
<span class="token comment"># 拉取最新版1.0.6</span>
<span class="token function">docker</span> pull ordinaryroad-docker.pkg.coding.net/ordinaryroad-barrage-fly/docker-pub/ordinaryroad-barrage-fly:1.0.6
<span class="token function">docker</span> pull ordinaryroad-docker.pkg.coding.net/ordinaryroad-barrage-fly/docker-pub/ordinaryroad-barrage-fly-arm64:1.0.6
<span class="token function">docker</span> pull ordinaryroad-docker.pkg.coding.net/ordinaryroad-barrage-fly/docker-pub/ordinaryroad-barrage-fly-ui:1.0.6
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1),A=t(`<blockquote><p>拉到本地后需要根据compose文件重命名镜像</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> tag ordinaryroad-docker.pkg.coding.net/ordinaryroad-barrage-fly/docker-pub/ordinaryroad-barrage-fly:1.0.6 ordinaryroad-barrage-fly
<span class="token function">docker</span> tag ordinaryroad-docker.pkg.coding.net/ordinaryroad-barrage-fly/docker-pub/ordinaryroad-barrage-fly-arm64:1.0.6 ordinaryroad-barrage-fly-arm64
<span class="token function">docker</span> tag ordinaryroad-docker.pkg.coding.net/ordinaryroad-barrage-fly/docker-pub/ordinaryroad-barrage-fly-ui:1.0.6 ordinaryroad-barrage-fly-ui
...
<span class="token key atrule">services</span><span class="token punctuation">:</span>
  ...
  <span class="token key atrule">ordinaryroad-barrage-fly</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">hostname</span><span class="token punctuation">:</span> ordinaryroad<span class="token punctuation">-</span>barrage<span class="token punctuation">-</span>fly
    <span class="token key atrule">restart</span><span class="token punctuation">:</span> always
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-2-本地打包运行" tabindex="-1"><a class="header-anchor" href="#_2-2-本地打包运行" aria-hidden="true">#</a> 2.2 本地打包运行</h2><ol><li>clone项目到本地</li><li>后端打包 <code>./gradlew clean bootJar</code></li><li>前端打包 <code>npm run build</code></li></ol>`,12);function f(R,h){const s=l("ExternalLinkIcon");return o(),i("div",null,[u,r,d,k,n("ul",null,[v,m,n("li",null,[a("在线生成RSA密钥对："),n("a",y,[a("https://www.bejson.com/enc/rsa/"),e(s)]),a(" （不需要第一行的"),b,a("和最后一行的"),g,a("）")])]),n("blockquote",null,[n("p",null,[a("镜像加速与拉取："),n("a",_,[a("仓库链接"),e(s)])]),S]),A])}const q=p(c,[["render",f],["__file","index.html.vue"]]);export{q as default};
