import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as p,c as l,b as n,d as a,e as o,a as c}from"./app-844cd06f.js";const i={},u=n("h1",{id:"_2-项目部署",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_2-项目部署","aria-hidden":"true"},"#"),a(" 2 项目部署")],-1),r=n("p",null,"项目前后端分离，可以使用Docker Compose进行部署，或者分别打包后部署",-1),k=n("h2",{id:"_2-1-docker-compose",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_2-1-docker-compose","aria-hidden":"true"},"#"),a(" 2.1 Docker Compose")],-1),d=n("blockquote",null,[n("p",null,[a("Docker Compose示例位于"),n("code",null,".docker"),a("目录中")])],-1),v=n("li",null,[a("arm64系统时，后端镜像请使用 "),n("code",null,"ordinaryroad-barrage-fly-arm64")],-1),m=n("li",null,[a("使用mysql、nginx时需要先build "),n("ul",null,[n("li",null,[n("code",null,"docker compose build ordinaryroad-barrage-fly-mysql")]),n("li",null,[n("code",null,"docker compose build ordinaryroad-barrage-fly-nginx")])])],-1),y={href:"https://www.bejson.com/enc/rsa/",target:"_blank",rel:"noopener noreferrer"},b=c(`<blockquote><p>镜像加速与拉取</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># DOCKER_OPTS=&quot;--registry-mirror=https://mirror.ccs.tencentyun.com&quot;</span>
<span class="token function">docker</span> pull ordinaryroad-docker.pkg.coding.net/ordinaryroad-barrage-fly/docker-pub/ordinaryroad-barrage-fly:<span class="token variable">$APP_VERSION</span>
<span class="token function">docker</span> pull ordinaryroad-docker.pkg.coding.net/ordinaryroad-barrage-fly/docker-pub/ordinaryroad-barrage-fly-arm64:<span class="token variable">$APP_VERSION</span>
<span class="token function">docker</span> pull ordinaryroad-docker.pkg.coding.net/ordinaryroad-barrage-fly/docker-pub/ordinaryroad-barrage-fly-ui:<span class="token variable">$APP_VERSION</span>
...
<span class="token key atrule">services</span><span class="token punctuation">:</span>
  ...
  <span class="token key atrule">ordinaryroad-barrage-fly</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">hostname</span><span class="token punctuation">:</span> ordinaryroad<span class="token punctuation">-</span>barrage<span class="token punctuation">-</span>fly
    <span class="token key atrule">restart</span><span class="token punctuation">:</span> always
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,10);function _(g,S){const s=t("ExternalLinkIcon");return p(),l("div",null,[u,r,k,d,n("ul",null,[v,m,n("li",null,[a("在线生成RSA密钥对："),n("a",y,[a("https://www.bejson.com/enc/rsa/"),o(s)]),a(" （不需要-----BEGIN PUBLIC KEY-----）")])]),b])}const R=e(i,[["render",_],["__file","index.html.vue"]]);export{R as default};
