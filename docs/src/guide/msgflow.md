...
| type     | 框架定义的消息类型，提供了一些通用的属性   | String | DANMU/GIFT/SUPER_CHAT/ENTER_ROOM/LIKE/LIVE_STATUS_CHANGE/ROOM_STATS/SOCIAL, [📌](https://github.com/OrdinaryRoad-Project/ordinaryroad-live-chat-client/tree/main/live-chat-client-commons/live-chat-client-commons-base/src/main/java/tech/ordinaryroad/live/chat/client/commons/base/msg) |
